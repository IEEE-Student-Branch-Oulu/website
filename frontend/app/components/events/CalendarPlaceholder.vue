...
<template>
  <section
    class="relative overflow-hidden rounded-2xl border border-dashed border-[var(--color-border)]"
  ...
  >
    ...
    >
      ...
      <div class="text-center">
        <p
          class="mb-1 font-mono text-[11px] uppercase tracking-[0.15em] text-[var(--color-ieee-blue)]"
        >
          Coming Soon
        </p>
